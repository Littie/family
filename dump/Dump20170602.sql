...
INSERT INTO `members` VALUES (1,'Father'),(2,'Mother'),(3,'Child');
...
CREATE TABLE `permission_user` (
  ...
  KEY `permission_fk_id_idx` (`permission_id`),
  KEY `user_fk_id_idx` (`user_id`),
  CONSTRAINT `permission_fk_id` FOREIGN KEY (`permission_id`) REFERENCES `permissions` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION,
...
INSERT INTO `permissions` VALUES (1,'import'),(2,'distribute');
